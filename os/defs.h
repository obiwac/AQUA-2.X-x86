	...
	#define GLIB_DEFAULT_HARDWARE_ACCELERATION 0
	#define __AQUA__WINDOW_TITLE "AQUA 2.X"
	...
	typedef struct { /// TODO the joystick struct and event handler + haptic feedback
		...
		unsigned short button; // or key in the case of a keyboard
		unsigned short key;
		unsigned short mod; // DEPRACATED do not use
